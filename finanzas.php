...
<table align="center" width="100%" cellspacing='2'>
        <tr>
            ...
            <table class='contenido' width='100%'>
                <tr>
                    <td class='tititems' width='40%'>Programa</td>
                    <td class='tititems' width='7%'>Gesti&oacute;n</td>
                    <td class='tititems' width='10%'>Ciudad</td>
                    <td class='tititems' width='18%'>Responsable</td>
                    <td class='tititems' width='11%'>Inicio Prog.</td>
                    <td class='tititems' width='10%'>Ejecuci&oacute;n</td>
                </tr>
                <?php
                    $col1="#dedede";
                    $col2="#efefef";
                ...
                <tr bgcolor='$colactual'>
                    ...
                    <a href='ejecucion_ingresos.php?idv=".$fila[0]."'><img src=\"images/ingresos.png\" alt=\"Ingresos\" title=\"Ingresos\" border=\"0\" /></a> <a href='ejecucion_gastos.php?idv=".$fila[0]."'><img src=\"images/gastos.png\" alt=\"Gastos\" title=\"Gastos\" border=\"0\" /></a>
                    </td>
                </tr>";
                    }
