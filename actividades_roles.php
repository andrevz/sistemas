...
<?php
                    ...
                    $sql_modulos = "select m.idmodulo, m.nombre, a.nombre titulo, ar.idrol, a.idactividad, ar.nivelacceso
                                   from modulo m inner join rolesmodulos r on r.idmodulo=m.idmodulo
                    ...
                    while ($fila=mysql_fetch_array($result)) {
                          ...
                          if ($fila["titulo"]<>"") {
                          print "<form name='asigna_actividad' method='post'><tr><td  class='tablatxt'>&rarr; ".$fila["titulo"]."</td>
