...
class PDF_MemImage extends FPDF
{
    ...
    //    $this->SetFillColor(230,240,255);
        ...
        $this->Cell(50);
        $this->Cell(100,7,'PLANIFICACION',0,1,'C');
        $this->SetFont('Arial','B',12);
...
//        $this->Rect(10,30,190,0);
    ...
    function Footer()
    {
        //PosiciÃƒÂ³nÃ‚Â a 1,5 cm del final
        $this->SetY(-15);
...
//                if ($fila_m[13]!=$materia) {
                    ...
                    $pdf->Cell(60,4,substr($fila_m[1],0,31).(strlen($fila_m[1])>31 ? "..." : ""),1,0,'L');
...
/*                } else {
                ...
                $pdf->Cell(32,4,substr($fila_m[11],0,20),1,0,'L');
