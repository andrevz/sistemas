...
//       if (acceso($_SESSION['idRol'], $fila_versiones[0],$fila_versiones[1],$fila_versiones[3],$fila_versiones[2],0,0)>=2) {
          ...
          $sql_m="SELECT p.nombre, v.gestion, c.nombre, m.nombre, pmvd.horas
                         FROM planmateriaversiondocente pmvd inner join materiaversion mv on mv.idmateriaversion=pmvd.idmateriaversion
