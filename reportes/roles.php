...
class PDF_MemImage extends FPDF
{
    ...
    //    $this->SetFillColor(230,240,255);
        ...
        $this->Cell(50);
        $this->Cell(100,7,'USUARIOS Y ROLES',0,1,'C');
        $this->SetFont('Arial','B',12);
...
$pdf->AliasNbPages();
          ...
          $sql_m="SELECT nombres, apellidos, codigo_UPB, login, r.nombre, r.idrol FROM recursohumano rh inner join rol r on r.idRol=rh.idRol where r.idrol<>2";


          $pdf->SetFont('Arial','B',8);
          $pdf->Cell(7,5,"Nro",1,0,'L');
          $pdf->Cell(90,5,"Nombre",1,0,'L');
          $pdf->Cell(15,5,"C�d. DTI",1,0,'L');
          ...
          while ($fila_m=mysql_fetch_array($res_m)) {
                    ...
                    $pdf->Cell(90,4,$fila_m[1].", ".$fila_m[0],1,0,'L');
                    $pdf->Cell(15,4,$fila_m[2],1,0,'L');
                $pdf->Cell(25,4,$fila_m[3],1,0,'L');
                $pdf->Cell(40,4,$fila_m[4],1,1,'L');
