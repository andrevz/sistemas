...
if (isset($_POST["MM_insert"]) && $insertar && !$bloqueado) {
    if ($_POST["vigentes"]=="") {
          $error="<font color='red'><b>Debe registrar obligatoriamente el n�mero de estudiantes vigentes</b></font>";
    ...
    if ($_POST["vigentes"]=="") {
          $error="<font color='red'><b>Deben registrar obligatoriamente el n�mero de estudiantes vigentes</b></font>";
    } else if (strlen($error)<1){
